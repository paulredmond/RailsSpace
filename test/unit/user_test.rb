...
class UserTest < Test::Unit::TestCase
  ...
  # Make user email can't be too long.
  ...
  def test_email_with_valid_examples
    user = @valid_user
    valid_endings = ['com', 'org', 'net', 'edu', 'es', 'jp', 'info']
  ...
  def test_screen_name_with_valid_examples
    ...
    valid_screen_names.each do |screen_name|
      ...
      assert user.valid?, "#{screen_name} should pass with validation but doesn't"
    end
  end
  ...
  def test_screen_name_with_invalid_examples
    ...
    invalid_screen_names.each do |screen_name|
      user.screen_name = screen_name
      assert !user.valid?, "#{screen_name} should't pass validation, but does"
    end
  end
end
